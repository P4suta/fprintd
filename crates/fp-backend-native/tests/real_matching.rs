...
//! Genuine BOZORTH3 matching through the whole [`fp_core::Device`] trait, hardware-free.
//!
...
use fp_backend_native::{Scenario, VirtualDeviceBuilder};
use fp_core::{Device, Finger, Minutia, Print, Template};
