...
//! [`fp_mindtct`] takes a **borrowing** [`fp_mindtct::GrayImage`] — it never copies the pixels it
...
impl Frame {
    /// Borrow this owned frame as an [`fp_mindtct::GrayImage`] for one detection pass.
    ///
    ...
    #[must_use]
    pub fn as_gray(&self) -> fp_mindtct::GrayImage<'_> {
        fp_mindtct::GrayImage {
            data: &self.data,
            width: self.width,
            height: self.height,
            ppi: self.ppi,
