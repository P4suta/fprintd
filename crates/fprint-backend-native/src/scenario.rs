...
pub enum CaptureOutcome {
    ...
    /// [`EnrollProgress::retry`](fprint_core::EnrollProgress::retry) during
...
impl Scenario {
    ...
    /// Force the next enrollment to report on-device storage as full ([`fprint_core::Error::DataFull`]).
