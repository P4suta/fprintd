...
//! the **stock upstream NBIS** algorithm (see `docs/bozorth3-algorithm.md`) and verified black-box
//! against the stock C tool. It is deliberately **not** derived from libfprint's patched `nbis/`
