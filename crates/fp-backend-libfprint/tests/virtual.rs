...
//! [`Print`] round-trips through `fp-fp3` — the D1 template-unification guarantee.
...
use fp_backend_libfprint::LibfprintBackend;
use fp_core::{Backend, Device, Finger, Print, Template};
