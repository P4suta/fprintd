...
//! Edge translation between libfprint's glib vocabulary and the pure `fp-core` model.
//!
...
// comes from the FP3 blob via `fp-fp3` (the single source of truth, per the D1 decision in
