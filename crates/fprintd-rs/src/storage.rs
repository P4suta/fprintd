...
//! [`fp_fp3`], keeping the wire quirks at the edge (ARCHITECTURE.md principle 3).
//!
...
use fp_core::{DeviceId, DriverId, Finger, Print};
...
impl Store {
    ...
    pub fn save(&self, print: &Print) -> Result<(), DaemonError> {
        ...
        let bytes = fp_fp3::to_bytes(print)
    ...
    pub fn load(
        ...
        let print = fp_fp3::from_bytes(&bytes).ok()?;
