...
//! `net.reactivated.Fprint.Device` contract and `fp_core`:
//!
...
use fp_core::{DeviceFeature, DeviceId, DeviceInfo, DriverId, Error, Finger, Print};
...
impl Device {
    ...
    /// Whether a finger is on the sensor. `fp_core` does not surface live finger-status
